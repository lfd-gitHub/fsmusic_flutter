...
class AlbumCard extends StatelessWidget {
  ...
  const AlbumCard(this.image, this.title, this.subTitle, {Key? key, this.margin = const EdgeInsets.symmetric(horizontal: 10)}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          FsmImage.asset(image, width: 140, height: 140),
